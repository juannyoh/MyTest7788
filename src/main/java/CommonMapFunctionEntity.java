...
/**
 * CommonMapFunctionEntity entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="common_map_function"
    ,catalog="saas_base"
)

public class CommonMapFunctionEntity  implements java.io.Serializable {
    ...
    /** default constructor */
    public CommonMapFunctionEntity() {
    }

	/** minimal constructor */
    public CommonMapFunctionEntity(String id) {
        this.id = id;
    }
    
    /** full constructor */
    public CommonMapFunctionEntity(String id, String name, String funCode, Short isMapadmin, Short isMapmems, Short isMapviews, Short isLayeradmin, Short isLayermems, Short isLayerviews, Short isClayermems, Short isClayerviews, String funGroup, Short funStatus, Timestamp createTime, String createUserid) {
        this.id = id;
        this.name = name;

...
////        List<LayerInfo> lists = Lists.newArrayList();
////        for (int i = 0; i < 3; i++) {
...
//
//        /*
//         * String settingValue=""; int i=1; List<Integer>
//         * list=Arrays.asList(1,2); System.out.println(list.contains(i));
//         */
//
